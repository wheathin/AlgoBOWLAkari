...
for n in num_lights:
    ...
    left = False
    right = False
    match i_grid[n[0]][n[1]]:
        case '4':
            if (n[0] > 0) and (n[1] > 0) and (n[0] < rows - 1) and (n[1] < cols - 1):
                if (i_grid[n[0] + 1][n[1]] == '.') and (i_grid[n[0]][n[1] - 1] == '.'):
                    if (i_grid[n[0]][n[1] + 1] == '.' and (i_grid[n[0] - 1][n[1]] == '.')):
                        if ((test_blank(n[0]+1, n[1]) + test_blank(n[0]-1, n[1]) + test_blank(n[0], n[1]+1) + test_blank(n[0], n[1]-1)) == 0):
                            i_grid[n[0] + 1][n[1]] = 'L'
                            i_grid[n[0] - 1][n[1]] = 'L'
                            i_grid[n[0]][n[1] + 1] = 'L'
                            i_grid[n[0]][n[1] - 1] = 'L'
        case '3':
            ...
            if (spots == 3):
                if (up and (test_blank(n[0]-1,n[1]) == 0)):
                    i_grid[n[0]-1][n[1]] = 'L'
                if (left and (test_blank(n[0],n[1]-1) == 0)):
                    i_grid[n[0]][n[1]-1] = 'L'
                if (right and (test_blank(n[0],n[1]+1) == 0)):
                    i_grid[n[0]][n[1]+1] = 'L'
                if (down and (test_blank(n[0]+1,n[1]) == 0)):
                    i_grid[n[0]+1][n[1]] = 'L'
